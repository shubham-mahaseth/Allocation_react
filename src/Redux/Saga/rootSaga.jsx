...
import {
  ...
  funcRuleTemplate, funcLocTemplate, FetchRuleTempNameData, FetchLocTempNameData,
  funcRuleTemplateData, funcLocTemplateData,
...
import { AllStsData, AllocIdsData, SearchASYData, SwitchASYData, CopyASYData, ValidASYData, MAprvData } from "./AllocationSummarySaga";
import { AllocDPkData, grid1ADPk, grid2ADPk, ADValidation, updateAdpk, restoreAdpk } from "./AllocDPkSaga";
import { AllocDashUserAlloc, AllocDashReleaseCount, AllocDashAllocCount, DAllocCall } from "./AllocDashboardSaga";
import { alcScdlBatch,updBthDt } from "./AllocationBatchSaga";
import {
  postSeedH1, postSeedH2,postSeedH3,postSeedItmDtl

} from "./SeedDataInsertSaga";
import {  RPTData,} from "./ReportsSaga";
import { RtvUsrDtls,RtvUsrsData,ValUSRAUTH, UserRegt_Status } from "./UserConfigDetailsSaga";
...
export function* rootSaga() {
  yield all([
    ...
    fork(MAprvData),
    fork(CollabCommData),
    fork(PostCollabCommData),
    fork(alcScdlBatch),
    fork(updBthDt),
     /* RL TEMPLATE STARTS */
     fork(funcRuleTemplate),
     fork(funcLocTemplate),
     fork(FetchRuleTempNameData),
     fork(FetchLocTempNameData),
     fork(funcRuleTemplateData),
     fork(funcLocTemplateData),
     /* RL TEMPLATE ENDS */
    fork(postSeedH1),
    fork(postSeedH2),
    fork(postSeedH3),
