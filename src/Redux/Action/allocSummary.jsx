...
export const postMAPRVRequest = createAction(
  actions.POST_MAPRV_REQUEST
);
export const postMAPRVSuccess = createAction(
  actions.POST_MAPRV_SUCCESS
);
export const postMAPRVError = createAction(
  actions.POST_MAPRV_ERROR
);
