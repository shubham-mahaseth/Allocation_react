...
const statusObj = [
    ...
    { code: 'APV', value: 'Approved' },
    { code: 'RSV', value: 'Reserved' }
];
const ScheduleAlloc = ({ allocNoData, setOpen_Schdl, setTab, setRTabCond, setDisCond, tab,
    ...
    useEffect(() => {
        if (sendDataChk) {
            ...
            if (!ApproveFreeseCheck) {
                console.log("allocNoData: :", allocNoData, sendData, alloc_Dtls);
    ...
    console.log("setSendData?.DATE_FROM:", sendData)
    ...
    const handleErase = (label) => {
        const dateSetters = {
            "DATE_FROM": () => {
                setSendData((prevState) => ({...prevState,DATE_FROM: '',}));
                setDateFrom('');
            },
            "DATE_TO": () => {
                setSendData((prevState) => ({...prevState,DATE_TO: '',}));
                setDateTo('');
            }
        };
                ...
                <Button
                    sx={{
                        ...
                        backgroundColor: "green", '&:hover': {
                            backgroundColor: "#3CB371", textShadow: "0 0 #000"
                ...
                <Button
                    sx={{
                        ...
                        backgroundColor: "maroon", '&:hover': {
                            backgroundColor: "#8B0000", boxShadow: 3
                            ...
                            >
                                ...
                                <div>
                                    <DatePicker
                                        ...
                                        maxDate={convert_Date_picker(sendData.DATE_TO)}
                                            ...
                                            <TextField
                                                ...
                                                InputProps={{
                                                    ...
                                                    endAdornment: (<>
                                                        ...
                                                        {(sendData?.DATE_FROM?.length > 0)
                                                            && <BsFillEraserFill fontSize="medium"
                                                                onClick={() => { handleErase('DATE_FROM') }} />
                                                        }
                                                    </>)
                                                }}
                                                inputProps={{
                            ...
                            <div className={ScheduleAllocation.float_container4}>
                                ...
                                >
                                    <DatePicker
                                        ...
                                        minDate={convert_Date_picker(sendData.DATE_FROM)}
                                        showYearDropdown  // Enable year dropdown
                                        showMonthDropdown
                                        scrollableMonthYearDropdown
                                        scrollableYearDropdown={true}
                                        ...
                                        customInput={
                                            ...
                                            <TextField
                                                ...
                                                InputProps={{
                                                    ...
                                                    endAdornment: (<>
                                                        <CalendarTodayIcon style={{ fontSize: "11px", margin: "0px 3px 0px 0px" }} />
                                                        {(sendData?.DATE_TO?.length > 0)
                                                            && <BsFillEraserFill fontSize="medium"
                                                                onClick={() =>  handleErase('DATE_TO')} />}
                                                    </>)
                                                }}
                                                inputProps={{
                                                    // min: new Date().toISOString().slice(0, 10),
