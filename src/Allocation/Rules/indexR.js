...
const RulesAndLocation = ({ allocNoData, tab, setTab, setIsValidQtyLimits, setRTabCond, setDisCond,
  ...
  setOpenDialog, setDialogData, packRLCheck
}) => {
  ...
  */
  ...
  useEffect(() => {
    if (
      ...
      if (RulesLocationData?.data?.updateChangeWeightsRL?.status === 500) {
        setOpenDialogRL(true);
        setDialogDataRL(String(RulesLocationData?.data?.updateChangeWeightsRL?.message));
        RulesLocationData.data.updateChangeWeightsRL.status = 0
      }
      setLoading(false);
    } else if (
      ...
      setLoading(false);
    } else if (RulesLocationData?.data?.RetrieveChangeWeightsRL?.status === 500) {
      setOpenDialogRL(true);
      setDialogDataRL(String(RulesLocationData?.data?.RetrieveChangeWeightsRL?.message));
      RulesLocationData.data.RetrieveChangeWeightsRL.status = 0
    } else if (
      RulesLocationData?.data?.deleteLocationRL
    ) {
      setDeleteLocationRL(RulesLocationData?.data?.deleteLocationRL);
            ...
            >
              ...
              <Button
                sx={{
                  ...
                  padding: "5px", fontFamily: "system-ui",
                  width: "100px", marginLeft: "5px", marginTop: "5px",'&:hover': {
