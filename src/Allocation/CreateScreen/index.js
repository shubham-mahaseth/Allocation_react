...
const swalStyles = makeStyles((theme) => ({
  customIcon: { fontSize: '10px', },
  myPopup: { width: '100px !important', height: '100px !important', },
  button: {
    backgroundColor: "#228B22",//theme.palette.primary.main,
    color: theme.palette.common.white, fontWeight: 'bold',
    //borderRadius: '4px',    //padding: '0.5rem 1rem',//marginLeft: "5px", marginTop: "2px",    // minWidth: '8rem',    // margin: '1rem',
    fontSize: "12px", padding: "5px", fontFamily: "system-ui", width: "100px",
  },
  cancelButton: {
    //backgroundColor: "red",//theme.palette.primary.main,
    color: theme.palette.common.white,
    // fontWeight: 'bold',    // borderRadius: '4px',    // //padding: '0.5rem 1rem',    // minWidth: '8rem',    // margin: '1rem',
    fontSize: "12px", backgroundColor: "maroon", padding: "5px", fontFamily: "system-ui", width: "100px",
    // marginLeft: "5px", marginTop: "2px",
  },
  title: { fontFamily: "system-ui", fontSize: "16px !important", fontWeight: 'bold', color: 'red', },
}));
...
const theme = createTheme({ palette: { indicator: { main: "red", }, }, });

const tabStyleCalcRed = {
  border: "solid 1px", borderRadius: '12px 12px 0px 0px', marginRight: '5px', fontWeight: "bold", color: '#46923C', padding: "10px", cursor: "pointer",
  '&.Mui-selected': { outline: '1px', color: "grey", borderColor: "grey", color: '#C30900', },
}

const tabStyleCalcGreen = {
  border: "solid 1px", borderRadius: '12px 12px 0px 0px', marginRight: '5px', fontWeight: "bold", color: '#C30900', padding: "10px", cursor: "pointer",
  '&.Mui-selected': { outline: '1px', color: "grey", borderColor: "grey", color: '#46923C', },
}

const tabStyleCalcDis = {
  border: "solid 1px", borderRadius: '12px 12px 0px 0px', marginRight: '5px', fontWeight: "bold", padding: "10px", cursor: "pointer",
...
const activeTabStyle = { backgroundColor: "lightblue", border: "1px solid grey", };


const useStyles = makeStyles({
  maindiv: {
    position: "relative", width: "calc(95vw - 0px)",
    "& table": {
      "& tr": {
  ...
  boxDiv: { textAlign: "initial", position: "relative", maxWidth: "1400px", },
  uploaddiv: { display: "flex", alignItems: "center", marginTop: "50px", textAlign: "start", gap: 20, },
  GobackDiv: { cursor: "pointer", },
  textField: { marginRight: "10px !important", },
  dateField: { "& .MuiInput-input": { color: "rgba(102,102,102,1)", }, },
  popUp: {
    position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 400,
    backgroundColor: "white", border: "2px solid #000", boxShadow: 24, padding: "20px 20px 20px 20px",
  },
  input: {
    height: "30px", '& input + fieldset': { boxShadow: "rgba(0, 0, 0, 0.19) 0px 1px 2px, rgba(0, 0, 0, 0.23) 0px 2px 2px", },
  },
  formRadio: { "& .MuiSvgIcon-root": { height: 18, width: 18, } },
  inputField: {
    width: "100%", height: 37.8, backgroundColor: "#f0f0f0",
    '& input + fieldset': { borderRadius: "0", boxShadow: "rgba(0, 0, 0, 0.19) 0px 1px 2px, rgba(0, 0, 0, 0.23) 0px 2px 2px" },
  },
  inputFieldTable: {
    width: "100%", height: 37.8, backgroundColor: "#f0f0f0",
    '& input + fieldset': { borderRadius: "5px", boxShadow: "rgba(0, 0, 0, 0.19) 0px 1px 2px, rgba(0, 0, 0, 0.23) 0px 2px 2px" },
  },
  inputFielddate: {
  ...
  float_child: { display: "inline-block", margin: "0px 0px 0px 8px", padding: "0rem 0rem", verticalAlign: "middle", },
  container: { display: "flex", float: "left" },
  container_child: { float: "left" },
  grid_child: { display: "inline-block", padding: "0rem 0.2rem", },
  course_box: { width: "100%", },
  listdropdown: { padding: "0" },
  hoverdropdown: { display: "inline-block", fontSize: "20px", },
  grid_block: { display: "inline-block", padding: "0rem 0rem", verticalAlign: "middle", },
  grid_container: { display: "inline-block", },
  header_container: { display: "inline-block", },
  header_child: { display: "inline-block", padding: "0rem 0.2rem", verticalAlign: "middle", },
  grid_child1: { display: "inline-block", margin: "0px 0px 0px 0px", padding: "0rem 0rem", verticalAlign: "middle", },
  TableCell: { color: "#fff", padding: "6px 6px !important", lineHeight: "1.2rem !important", },
  TitleHead: { position: "sticky", top: -1, },
  multiselectfield: { display: "inline-block", margin: "0rem", padding: "0rem 0rem", verticalAlign: "middle", },
  root: { "& .MuiFilledInput-root": { background: "rgb(232, 241, 250)" } },
  TitleRow: { height: 20 },
  Desc_column: { fontSmooth: "always", fontSize: "13px", color: "black", padding: "0px" },
  backdrop: { zIndex: 999, color: '#fff', },
  menuContent: {
    position: 'absolute', top: '100%', left: 0, backgroundColor: theme.palette.background.paper,
    borderRadius: theme.shape.borderRadius, padding: theme.spacing(1),
    zIndex: 999, display: 'none', padding: "1px", border: "1px solid lightgrey", margin: "0px 0px 0px 0px"
  },
  menuContentVisible: { display: 'block', padding: "1px", border: "1px solid lightgrey", margin: "0px" },
  drawerDiv: { padding: "0px 0px 10px 0px" }
});
...
const CreateAllocation = ({ screenName, callData, callMode, rlCheck, setCheck, setTabFltrData,
  ...
  setcurrentPageRowsAllSumm, setcurrentPageDataAllSumm, aSMPage, setOpenDialogASM, setDialogDataASM
  , handleSearch, setRtnSwtich, setIsLoadingAllocSumm, isLoadingAllocSumm }
) => {
  ...
  const [collabStatus, setCollabStatus] = useState(false);

  const [commStatus, setCommStatus] = useState(false);
  // const [collabText, setCollabText]    = useState("Hello, Collaborators");
  const collabText = useRef('');
  ...
  useEffect(() => {
    if (CreateAllocationData?.data?.totalData && Array.isArray(CreateAllocationData?.data?.totalData)) {
      ...
      if (CreateAllocationData?.data?.switchTab?.status === 200) {
        if (CreateAllocationData?.data?.switchTab?.message[1] === 1) {
          ...
          if (Array(CreateAllocationData?.data?.switchTab?.message[0]).length !== 0) {
            setLIMData(CreateAllocationData?.data?.switchTab?.message[0]);
            setTab("3")
            setLimCheck(false);
          } else {
            setOpenDialog(true);
            setDialogData(String((CreateAllocationData?.data?.switchTab?.message[0])[1]))
          }
          // setLIMData(CreateAllocationData?.data?.switchTab?.message[0]);
          // setTab("3")
          // setLimCheck(false);
    ...
    if (CreateAllocationData?.data?.schdlData?.status === 500) {
      setOpenDialog(true);
      setDialogData(String(CreateAllocationData?.data?.schdlData?.message))
      setIsLoading(false);
      setOpen_Schdl(false);
    }
    ...
    // if (AllocSummaryCreateData?.data?.switchAsyData?.status === 500 &&
    //   (AllocSummaryData1?.data?.switchAsyData?.message.toUpperCase()).includes("CONNECTION"))
    // {
    //   setIsLoading(false);
    //   setOpenDialog(true);
    //   setDialogData("CONNECTION LOST");
    // }
    if (CreateAllocationData?.data?.rtvCommData && Array.isArray(CreateAllocationData?.data?.rtvCommData)
    ) {
      const commDataFltr = CreateAllocationData?.data?.rtvCommData?.map(item => {
      ...
      setCommTabData(commDataFltr);
      setIsLoading(false);
    } else if (CreateAllocationData?.data?.InsCollab?.status) {
      if (CreateAllocationData?.data?.InsCollab?.status === 201) {
        dispatch(postRtvCommRequest([allocNoData]));
        setCommFltrData([]);
      }
    ...
    } else if (CreateAllocationData?.data?.rtvCommData?.status === 500) {
      setIsLoading(false);
      setCommTabData([]);
    }
  ...
  useEffect(() => {
    ...
    //   if (AllocSummaryCreateData?.data?.switchAsyData.message === "SWITCH : CONNECTION LOST" || AllocSummaryCreateData?.data?.switchAsyData.message.toUpperCase().includes("CONNECTION")) 
    if (AllocSummaryCreateData?.data?.switchAsyData?.status === 500) {
      setOpenDialogASM(true);
      setDialogDataASM(AllocSummaryCreateData?.data?.switchAsyData?.message)
      setCheck(false);
      setSwtBkAsm(true);
      setOpen_Schdl(false);
      setIsLoading(false);
      ...
      AllocSummaryCreateData.data.switchAsyData.status = 0
      document.title = 'Alloc Summary';
    }
  ...
  */
  ...
  let UniqDept = hierData.length > 0 ? [...new Map(hierData.map((item) => [item["HIER1"], item])).values()] : [];

  let UniqClass = hier2Data.length > 0 ? [...new Map(hier2Data.map((item) => [item["HIER2"], item])).values()] : [];

  let UniqSubClass = hier3Data.length > 0 ? [...new Map(hier3Data.map((item) => [item["HIER3"], item])).values()] : [];

  let UniqItemParent = itemParentData.length > 0 ? [...new Map(itemParentData.map((item) => [item["ITEM_PARENT"], item])).values()] : [];

  let UniqPOType = poTypeData.length > 0 ? [...new Map(poTypeData.map((item) => [item["PO_TYPE"], item])).values()] : [];

  let UniqPO = poData.length > 0 ? [...new Map(poData.map((item) => [item["PO"], item])).values()] : [];

  let UniqUDA = udaData.length > 0 ? [...new Map(udaData.map((item) => [item["UDA"], item])).values()] : [];

  let UniqExcludeUDA = excludeUdaData.length > 0 ? [...new Map(excludeUdaData.map((item) => [item["EXCLUDE_UDA"], item])).values()] : [];

  let UniqVPN = vpnData.length > 0 ? [...new Map(vpnData.map((item) => [item["VPN"], item])).values()] : [];

  let UniqSKU = skuData.length > 0 ? [...new Map(skuData.map((item) => [item["SKU"], item])).values()] : [];

  let UniqDiff_id = diffData.length > 0 ? [...new Map(diffData.map((item) => [item["DIFF_ID"], item])).values()] : [];
  ...
  useEffect(() => {
    ...
    if (CreateAllocationData?.data?.totalData?.status === 500) {
      setHeaderDis(false);
      setTotalData([]);
      setTabledata([]);
      setAllData([]);
  ...
  const handleDateErase = (label) => {
    const dateSetters = {
      "RELEASE_DATE": () => {
        setReleaseDate("");
        setInitialDateRD("");
        setSearchHeaderData(prev => ({ ...prev, RELEASE_DATE: "" }));
      },
      "CREATED_DATE": () => {
        setSearchHeaderData(prev => ({ ...prev, CREATED_DATE: "" }));
      },
      "EISD_START_DATE": () => {
        setSearchDataCCommon(prev => ({ ...prev, EISD_START_DATE: "" }));
      },
      "EISD_END_DATE": () => {
        setSearchDataCCommon(prev => ({ ...prev, EISD_END_DATE: "" }));
      },
      "START_DATE": () => {
        setSearchDataCCommon(prev => ({ ...prev, START_DATE: "" }));
      },
      "END_DATE": () => {
        setSearchDataCCommon(prev => ({ ...prev, END_DATE: "" }));
      }
    };
  ...
  const handleDatePicker = (name, date) => {
    ...
    switch (name) {
      ...
      case "RELEASE_DATE":
        ...
        console.log("initialDateR:1:", date);
        setInitialDateRD(date);
        break;
      case "EISD_START_DATE":

        setSearchDataCCommon((prev) => {
          return {
            ...prev,
            EISD_START_DATE: formattedDate,
          };
        });

        console.log("EISD_START_DATE -> initialDateR:1:", date);
        break;
      case "EISD_END_DATE":
        ...
        setSearchDataCCommon((prev) => {
          return {
            ...prev,
            EISD_END_DATE: formattedDate,
          };
        });

        console.log("EISD_END_DATE -> initialDateR:1:", date,);
        break;
      case "START_DATE":
        ...
        console.log("START_DATE -> initialDateR:1:", date,);
        break;
      case "END_DATE":
        ...
        console.log("END_DATE -> initialDateR:1:", date,);
        break;
      default:
        break;
  ...
  const collabfunc = () => {
    ...
    // console.log("COLLAB allocNoData : ", allocNoData)
    setIsLoading(true);
    dispatch(postRtvCommRequest([allocNoData]));
  ...
  const handleCollabChange = (e) => { //onBlur
    const newText = e.target.value;
    setNewCollabText(newText);
  };
  const handleCommOk = () => {
    if (newCollabText.length > 0) {
      setIsLoading(true);
      dispatch(postInsCommRequest([{
        ...allocNoData, 'USER': JSON.parse(localStorage.getItem("userData"))?.username,
        'COMMENT': newCollabText
      }
      ]))
      setNewCollabText("");
    } else {
  ...
  */
          ...
          <div className={CreateAllocationClasses.float_child}>
            ...
            <div>
              ...
              <DatePicker
                ...
                selected={convert_Date_picker(searchDataCCommon.EISD_START_DATE)}
                onChangeRaw={(event) => {
                  event.preventDefault();
                }}
                maxDate={convert_Date_picker(searchDataCCommon.EISD_END_DATE)}
                onChange={(date) => handleDatePicker("EISD_START_DATE", date)}
                ...
                customInput={
                  ...
                  <TextField
                    ...
                    InputProps={{
                      style: (((searchHeaderData["CONTEXT"] === "PROM") ? (
                        searchHeaderData["ALLOC_DESC"].length > 0
                          && searchHeaderData["ALLOC_LEVEL"].length > 0
                          && searchHeaderData["CONTEXT"].length > 0
                          && searchHeaderData["ALLOC_TYPE"].length > 0
                        ...
                        (
                          searchHeaderData["ALLOC_DESC"].length > 0
                            ...
                            && searchHeaderData["ALLOC_TYPE"].length > 0
                            && searchHeaderData["RELEASE_DATE"].length > 0
                            ? false : true)) || ApproveFreeseCheck) ? sharedInputClassDis : sharedInputClass,
                      endAdornment: (<>
                        <CalendarTodayIcon style={{ fontSize: "11px", margin: "0px 3px 0px 0px" }} />
                        {(searchDataCCommon?.EISD_START_DATE?.length > 0)
                          && <BsFillEraserFill fontSize="medium"
                            onClick={() => handleDateErase("EISD_START_DATE")} />}
                      </>)
                    }}
                    inputProps={{
          ...
          <div className={CreateAllocationClasses.float_child}>
            ...
            <div>
              ...
              <DatePicker
                autoComplete="off"
                placeholderText="MM-DD-YY"
                selected={convert_Date_picker(searchDataCCommon.EISD_END_DATE)}
                onChangeRaw={(event) => {
                  event.preventDefault();
                }}
                minDate={convert_Date_picker(searchDataCCommon.EISD_START_DATE)}
                onChange={(date) => handleDatePicker("EISD_END_DATE", date)}
                showYearDropdown  // Enable year dropdown
                showMonthDropdown
                scrollableMonthYearDropdown
                scrollableYearDropdown={true}
                yearDropdownItemNumber={300}
                dateFormat="MM-dd-yy"
                disabled={!["ALLOC_DESC", "ALLOC_LEVEL", "CONTEXT", "ALLOC_TYPE", "RELEASE_DATE"].every(
                  field => searchHeaderData[field].length > 0
                ) ||
                  (searchHeaderData["CONTEXT"] === "PROM" && searchHeaderData["PROMOTION"].toString().length === 0) ||
                  ApproveFreeseCheck
                }
                customInput={
                  ...
                  <TextField
                    ...
                    InputProps={{
                      style: (
                        !["ALLOC_DESC", "ALLOC_LEVEL", "CONTEXT", "ALLOC_TYPE", "RELEASE_DATE"].every(field => searchHeaderData[field].length > 0) ||
                        (searchHeaderData["CONTEXT"] === "PROM" && searchHeaderData["PROMOTION"].toString().length === 0) ||
                        ApproveFreeseCheck) ? sharedInputClassDis : sharedInputClass,
                      endAdornment: (<>
                        <CalendarTodayIcon style={{ fontSize: "11px", margin: "0px 3px 0px 0px" }} />
                        {(searchDataCCommon?.EISD_END_DATE?.length > 0)
                          && <BsFillEraserFill fontSize="medium"
                            onClick={() => handleDateErase("EISD_END_DATE")} />}
                      </>)
                    }}
                    inputProps={{
                      // min: new Date().toISOString().slice(0, 10),
          ...
          <div className={CreateAllocationClasses.float_child}>
            ...
            <div>
              ...
              <DatePicker
                autoComplete="off"
                placeholderText="MM-DD-YY"
                selected={convert_Date_picker(searchDataCCommon.START_DATE)}
                onChangeRaw={(event) => {
                  event.preventDefault();
                }}
                maxDate={convert_Date_picker(searchDataCCommon.END_DATE)}
                onChange={(date) => handleDatePicker("START_DATE", date)}
                showYearDropdown  // Enable year dropdown
                showMonthDropdown
                scrollableMonthYearDropdown
                scrollableYearDropdown={true}
                ...
                customInput={
                  ...
                  <TextField
                    ...
                    InputProps={{
                      ...
                      endAdornment: (<>
                        <CalendarTodayIcon style={{ fontSize: "11px", margin: "0px 3px 0px 0px" }} />
                        {(searchDataCCommon?.START_DATE?.length > 0)
                          && <BsFillEraserFill fontSize="medium"
                            onClick={() => handleDateErase("START_DATE")} />}
                      </>)
                    }}
                    inputProps={{
                      // min: new Date().toISOString().slice(0, 10),
          ...
          <div className={CreateAllocationClasses.float_child}>
            ...
            <div>
              ...
              <DatePicker
                autoComplete="off"
                placeholderText="MM-DD-YY"
                selected={convert_Date_picker(searchDataCCommon.END_DATE)}
                onChangeRaw={(event) => {
                  event.preventDefault();
                }}
                minDate={convert_Date_picker(searchDataCCommon.START_DATE)}
                onChange={(date) => handleDatePicker("END_DATE", date)}
                showYearDropdown  // Enable year dropdown
                showMonthDropdown
                scrollableMonthYearDropdown
                scrollableYearDropdown={true}
                ...
                customInput={
                  ...
                  <TextField
                    ...
                    InputProps={{
                      ...
                      endAdornment: (<>
                        <CalendarTodayIcon style={{ fontSize: "11px", margin: "0px 3px 0px 0px" }} />
                        {(searchDataCCommon?.END_DATE?.length > 0)
                          && <BsFillEraserFill fontSize="medium"
                            onClick={() => handleDateErase("END_DATE")} />}
                      </>)
                    }}
                    inputProps={{
                      // min: new Date().toISOString().slice(0, 10),
      ...
      <div>
        ...
        <div className={CreateAllocationClasses.grid_child1}>
          <Button
            ...
            variant="contained"
            startIcon={<Groups3Icon sx={{ padding: "0px" }} />}
            // startIcon={<CachedIcon  />}
            onClick={collabfunc}
          >Collab</Button>
        </div>
        ...
        <div className={CreateAllocationClasses.grid_child1}>
          <Button
            ...
            sx={CalculatescreenTabColor
              ? {
                backgroundColor: "maroon", fontSize: "12px",
                padding: "5px", fontFamily: "system-ui",
                width: "125px", marginLeft: "5px", marginTop: "2px",
                '&.Mui-disabled': {
                  opacity: 0.5,
              ...
              : {
                backgroundColor: "#228B22", fontSize: "12px",
                padding: "5px", fontFamily: "system-ui",
                width: "125px", marginLeft: "5px", marginTop: "2px",
                '&.Mui-disabled': {
                  opacity: 0.5,
            ...
            onClick={() => {
              if (searchHeaderData.ALLOC_TYPE !== "S") {
                Calc_func();
              }
            }}
  ...
  const handleOk = () => {
    const tableDataIndx = totalData.map((_, index) => index + 1);
    const combinedList = Object.values(selected[0]).flat();
    // const unchkdList = tableDataIndx.filter(index => !combinedList.includes(index));
    // const unChkdData = Object.values({...(unchkdList.map(index => totalData[index-1]))});
    const SEL_IND_DATA = totalData.filter(item => combinedList.includes(item.SR_NO))

    // console.log("Table item ::" ,saveData,unChkdData);
    if (callMode === "VIEW" || callMode === "EDIT") {
      const saveData = {
        ...
        SELECTED_TOTALDATA: SEL_IND_DATA
  ...
  const handleClear = () => {
    // console.log("initialDateR: ",initialDateR,searchHeaderData.RELEASE_DATE);
  ...
  const handleToday = () => {
    ...
    const initialDateParts = new Date().toISOString().slice(0, 10).split('-');
    const initialDateR = new Date(
      Number(initialDateParts[0]), // Year
      Number(initialDateParts[1]) - 1, // Month (0-based index)
      Number(initialDateParts[2]) // Day
    );
    console.log("initialDateR: ", initialDateR, initialDateParts, new Date(), ":", initialDateParts[2], "::", initialDateParts[0], ":::",
      initialDateParts[1]);
    setInitialDateRD(initialDateR);
    setReleaseDate(convertDateFormat(new Date().toISOString().slice(0, 10)))
  };
          ...
          <div className={CreateAllocationClasses.header_child}>
            ...
            <div>
              {/* <TextField
                ...
                disabled={!searchHeaderData.ALLOC_NO || ApproveFreeseCheck || CalcCheck}
                sx={{
                  margin: "0px 0px 2px 0px", width: "120px"
                  , "& .MuiInputBase-input.Mui-disabled": {
                    backgroundColor: "#f0f0f0",
                    borderRadius: "5px",
                    height: "15px",
                ...
                inputProps={{
                  min: new Date().toISOString().slice(0, 10),
                  maxLength: 20,
                  sx: { backgroundColor: '#fff', height: "20px", textAlign: "center", }
                }}
                InputProps={{
                  style: { fontSize: 12, height: "30px" },
                  className: CreateAllocationClasses.input,
                ...
                onChange={onChange}
                //value={dayjs(allocDetails.length > 0 ? allocDetails[0].RELEASE_DATE : searchHeaderData.RELEASE_DATE, 'MM-DD-YYYY').format('YYYY-MM-DD')}
                value={allocDetails.length > 0 ? allocDetails[0].RELEASE_DATE : searchHeaderData.RELEASE_DATE}
                defaultValue={allocDetails.length > 0 ? allocDetails[0].RELEASE_DATE : searchHeaderData.RELEASE_DATE}
              /> */}
              <DatePicker
                autoComplete="off"
                placeholderText="MM-DD-YY"
                selected={initialDateRD}
                minDate={new Date()}
                ...
                customInput={
                  ...
                  <TextField
                    ...
                    InputProps={{
                      ...
                      endAdornment: (<>
                        <CalendarTodayIcon style={{ fontSize: "11px", margin: "0px 3px 0px 0px" }} />
                        {/* {(searchHeaderData?.RELEASE_DATE?.length > 0 && !ApproveFreeseCheck)
                          && <BsFillEraserFill fontSize="medium"
  ...
  const handleSelectAllClick = (event) => {
    ...
    //   ));
    const filteredArray = searchHeaderData.ALLOC_TYPE === "S" ? currentPageData.filter(obj => obj.ERR_IND !== "E") : currentPageData;
  ...
  const onTableCellChange = (e, value) => {
    ...
    const combinedList = Object.values(selected[0]).flat()
    const temp1 = updatedData.filter(item => combinedList.includes(item.SR_NO))
    setSelData(temp1);
  };
    ...
    if (RulesLocationData?.data?.rtvrldata
      ...
      if (RulesLocationData?.data?.rtvrldata?.status === 200) {
        if (RulesLocationData?.data?.rtvrldata?.message[0].DATA === 0) {
          setrtvrldata([]);
          if (String(RulesLocationData?.data?.rtvrldata?.message[0].ALLOC_RULE).length > 0 || String(RulesLocationData?.data?.rtvrldata?.message[0].ALLOC_LOCATION).length > 0) {
            setDialogData("Rules & Location retrieve is failed: " + String(RulesLocationData?.data?.rtvrldata?.message[0].ALLOC_RULE) + "." + String(RulesLocationData?.data?.rtvrldata?.message[0].ALLOC_LOCATION))
            setOpenDialog(true)
          }
  ...
  const [packRLCheck, setPackRLCheck] = useState(false);
  const handleSelectInd = (val) => {
    ...
    if (val === 1) {
      const packCheck = totalData.filter(obj => obj.PACK_IND === "Y" && allPageSelected.includes(obj.SR_NO))
      if (packCheck.length > 0) {
        setPackRLCheck(true);
      } else {
        setPackRLCheck(false);
      }
      setrtvrldata([])
  ...
  */
  ...
  useEffect(() => {
    if (CreateAllocationData?.data?.errRptData?.status === 500) {
      setIsLoading(false);
      if (String(CreateAllocationData?.data?.errRptData?.message).length !== 0) {
        setOpenDialog(true);
      ...
      //     : [];
      setErrReportData(CreateAllocationData?.data?.errRptData?.message);
      if ((CreateAllocationData?.data?.errRptData?.message).length > 0) {
        setIsLoading(false);
  ...
  */
  useEffect(() => {
    ...
    if ((ADPackCreateData?.data?.aDPkData?.status) === 500 || (ADPackCreateData?.data?.aDPkData?.status) === 501) {
      ...
      setValAD(false);
      setTab('1');
      ADPackCreateData.data.aDPkData.status = 0
  ...
  const handleRowClick = (rowId) => {
    // const checkERR1 = currentPageData.filter(obj => obj.SR_NO === rowId && obj.ERR_IND !== "E");
    // const checkERR2 = currentPageData.filter(obj => obj.SR_NO === rowId && obj.ERR_IND !== "W");
    // console.log("checkERR", checkERR1, checkERR2)
    // if (checkERR1.length > 0 && checkERR2.length > 0) {
    ...
    <Box className={CreateAllocationClasses.maindiv}>
                                ...
                                currentPageData.map((row, index) => {
                                  ...
                                  return (
                                    <StyledTableRow
                                      ...
                                      style={{
                                        backgroundColor:
                                          selectedRow === row.SR_NO && row.ERR_IND === 'W' ? "#FFF2B2" :
                                            selectedRow === row.SR_NO && row.ERR_IND === 'E' ? "#FF9999" :
                                              selectedRow === row.SR_NO ? "#CDF0FF" :
                                                row.ERR_IND === 'E' ? "#FF6666" :
                                                  row.ERR_IND === 'W' ? "#FADA5E" : {}
                                      }}
                                    >
                                      <TableCell sx={{ padding: "0px", textAlign: "left", fontSize: "12px", width: "1%" }}>
                                        <Checkbox
                                          disabled={ApproveFreeseCheck || (searchHeaderData.ALLOC_TYPE === "S" && row.ERR_IND === "E")}
                                          color="primary"
                                          size="small"
      ...
      <div>
        <Dialog
          ...
          disableBackdropClick
        >
          <DialogTitle id="draggable-dialog-title" sx={{ padding: "5px 0px 0px 10px", margin: "0px" }}>
            {/* COLLAB */}
          </DialogTitle>
          <DialogContent sx={{ padding: "0px 8px 0px 8px", margin: "0px", }}>
            <Box
              component="fieldset"
              display="flex"
            ...
            >
              ...
              <TextField
                ...
                rows={5}
                variant="outlined"
                // value={collabText.current}
                onBlur={handleCollabChange}
      ...
      <div >
        ...
        >
          ...
          >
            <DialogContentText>
              <Collab
                commTabData={commTabData}
                commFltrData={commFltrData}
                setCommFltrData={setCommFltrData}
              />
            </DialogContentText>
          </DialogContent>
          <DialogActions>
            <Button
              sx={{
                ...
                backgroundColor: "#228B22",
                padding: "5px", fontFamily: "system-ui",
                width: "150px", marginLeft: "5px", marginTop: "2px",
                '&.Mui-disabled': {
                  opacity: 0.5,
                  backgroundColor: 'DodgerBlue',
                  color: '#fff',
              ...
              disabled={ApproveFreeseCheck || (typeof callMode !== "undefined" ? callMode === "VIEW" : false)}
              variant="contained">
              ADD COMMENT
            </Button>
            <Button
