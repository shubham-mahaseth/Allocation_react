...
//console.log("currentPageData",currentPageData)
    ...
    const SubmitValueList = () => {
        const temp = qtyLimitsData.filter(obj => obj.MIN < obj.MIN_NEED)
        if (temp.length > 0) {
                            ...
                            >
                                ...
                                <div>
                                    <div className={QuantityLimitsClasses.float_child}>
                                        <Button sx={{ backgroundColor: "#228B22", fontSize: "12px", margin: "0px 5px 0px 0px", width: "100px" }}
                                            variant="contained"
                                        ...
                                        <Button sx={{ backgroundColor: "maroon", fontSize: "12px", margin: "0px 5px 0px 0px", width: "100px" }}
                                            variant="contained"
                                            // className={QuantityLimitsData.textField}
                                            type="submit"
            ...
            <div>
                <Dialog open={dialogOpen} disableBackdropClick={true} maxWidth="xs" PaperComponent={PaperComponent}
                    ...
                    <DialogActions sx={{ padding: "0px 0px 10px 0px", margin: "0px", }}>
                        <Button sx={{ backgroundColor: "#228B22", fontSize: "12px", margin: "0px 5px 0px 0px", width: "100px" }} variant="contained"
                            startIcon={<DoneAllIcon />} onClick={handleDialogOk}>Yes</Button>

                        <Button sx={{ backgroundColor: "maroon", fontSize: "12px", margin: "0px 5px 0px 0px", width: "100px" }} variant="contained"
