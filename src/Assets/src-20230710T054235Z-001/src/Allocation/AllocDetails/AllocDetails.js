...
useEffect(()=>{
    ...
    */
    if (editAQCheck && editAQ.length > 0) {
        ...
        setLocGrpData(filtrdItemWHData);
                                                            ...
                                                            filtrdItemWHData.length > 0 ?
                                                                filtrdItemWHData.map(row => (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {ManageHeaderDataItemWHDtl.includes('SPREAD_QTY') && false ?
                                                            ...
                                                            {ManageHeaderDataLocGroup.includes('GROUP_ID') ?
                                                                <TableCell sx={{
                                                                    ...
                                                                    <TextField
                                                                        ...
                                                                        name="GROUP_ID"
                                                                        // onChange={gridFilterLocGrp}
                                                                        // value={Object.keys(inputValue).length > 0 && Object.keys(inputValue).includes("LOC_LIST") > 0 ? inputValue.LOC_LIST : ""}
